        ...
        <div className="flex flex-col md:flex-row gap-16 items-center">
          <div className="md:w-1/2">
            <div className="relative">
              <div className="aspect-square w-full bg-gradient-to-tr from-gray-50 to-white rounded-3xl overflow-hidden relative shadow-lg">
                <div className="absolute -top-6 -right-6 w-24 h-24 bg-pink-100 rounded-full"></div>
                <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-pink-50 rounded-full"></div>
                  ...
                  <div className="relative w-full h-full bg-white rounded-2xl shadow-inner overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center p-6">
                      <div className="text-center">
                        <div className="w-32 h-32 bg-pink-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                          <span className="text-white text-5xl font-bold">P</span>
                        </div>
                        <span className="text-pink-600 text-4xl font-bold">PrintSmart</span>
                        <p className="text-gray-500 mt-2">Est. 2024</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-gradient-to-tl from-pink-100 to-pink-50 rounded-3xl -z-10"></div>
            </div>
          </div>
